...
![tests: 188 passing](https://img.shields.io/badge/tests-188%20passing-brightgreen.svg)
...
| 📜 **Git per build** | The workspace is a git repo; one commit per task. History view + **undo a task**. **Transcripts**: read what every role said on every run. |
