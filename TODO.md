...
- [x] Homebrew / Docker packaging — `Dockerfile` (Playwright base, /data volume, verified), `homebrew/projectinator.rb` + `scripts/brew-formula.sh` (tap repo to create: smanookian/homebrew-projectinator), `PROJECTINATOR_HOME`.
